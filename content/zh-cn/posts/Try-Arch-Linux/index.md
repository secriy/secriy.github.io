...
date: '2020-07-30T10:29:44+08:00'
categories: 经验教程
tags:
  - Linux
draft: false
...
- [镜像](https://www.archlinux.org/download/)
    ...
    ![](assets/image-20200730104226652.png)
...
5. 磁盘分区
    ...
    **以下命令参照自身情况自行修改：**
    ...
    ![](assets/DeepinScreenshot_plasmashell_20201022011144.png)
...
![将xsettingsd设置为自启动](assets/DeepinScreenshot_select-area_20200801023450-1596222003471.png)
...
1. 无法使用中文
    ...
    ![](assets/DeepinScreenshot_select-area_20201011151238.png)
...
4. Jetbrains 系列软件无法使用 GlobalMenu（全局菜单）
    ...
    ![](assets/image-20210117230158797.png)

    因此可以确定是找不到 JavaFX 环境，在**Plugins Marketplace**下载安装即可。

    ![](assets/image-20210117230358483.png)
